                            ...
                            <div class="panel-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $query11="select student_id,name,email from student NATURAL JOIN course_student_enrolment  where course_id=$cid";
                                    ...
                                    $query="select course_student_id from course_student_enrolment where course_id=$cid and teacher_id=$id and student_id=$a";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $result11['email']; ?></td>
                                            <td>
                                                Present <input type="radio" name="Attendance[<?php echo $result11['student_id']; ?>]" value="Present"> Absent <input type="radio" name="Attendance[<?php echo $result11['student_id']; ?>]" value="Absent">
                               ...
                               if (isset($_POST['Atten'])){
                                ...
                                $cid=$_SESSION['cid'];
                                    ...
                                    $query="select course_student_id from course_student_enrolment where course_id=$cid";
                                                            $execute1=mysqli_query($conn, $query);
                                                            $result=mysqli_fetch_assoc($execute1);
                                                            $csi=$result['course_student_id']; 
                                    ...
                                    $q1="select date from attendance where course_student_id=$csi ";
                                    $r1=$conn->query($q1);
                                    $b=false;
                                    if($r1->num_rows>0){

                                        while($check=$r1->fetch_assoc())
                                        { 
                                            if($date==$check['date'])
                                            {
                                                $b=true;
                                    ...
                                    foreach ($att as $key => $value) {
                                        ...
                                        if($value=="Present"){ 
                                            ...
                                            $INSERT="insert into attendance(course_student_id,status) values($csi,'Present')";
                                            $insertResult=$conn->query($INSERT);

                                            
                                        }else{ 
                                        
                                            $INSERT="insert into attendance(course_student_id,status) values($csi,'Absent')";
                                            $insertResult=$conn->query($INSERT);
